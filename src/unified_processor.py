...
# Подавляем предупреждения в начале
import warnings
...
from src.segment_config import SegmentConfig, get_default_config
...
from src.schemas.models import ExtractorResult, ManifestModel
from src.smart_gpu_detector import get_smart_detector, get_smart_config, is_gpu_available
