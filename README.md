...
**Асинхронный GPU-оптимизированный микросервис для извлечения аудио признаков**

Построен на FastAPI + Celery архитектуре с модульной системой extractors. Поддерживает обработку как аудио файлов, так и извлечение аудио из видео с последующим полным анализом. **Полностью асинхронный с GPU-оптимизацией для максимальной производительности!** Готов к продакшену!

## 🚀 Async GPU-Optimized API

**Unified AudioProcessor** теперь полностью асинхронный с GPU-оптимизацией и поддерживает гибкую обработку аудио с тремя режимами:
